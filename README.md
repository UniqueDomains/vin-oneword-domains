...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C393%20rows-8250df">
...
> **Important:** this repository is a **public 9,393-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,097 domains** on the canonical page below.

**Public extract:** 9,393 rows · **Live catalog:** 5,622,097 domains
...
- `vin.csv` — public CSV extract (9,393 rows)
- `vin.json` — public JSON extract (9,393 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,393-row public sample | 5,622,097 live domains                           |
...
> Unique Domains. *Available .VIN One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
